...
db_solv = connect(solv_json)
db_out  = connect(out_json)
...
abb_name = db_solv.get(num=num).abb_name
...
for ion in ions:
	ion_json  = "sode_" + ion + ".json"
	db_ion  = connect(ion_json)
...
db_out.write(solv,num=num, smiles=smiles, abb_name=abb_name,
